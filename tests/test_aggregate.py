...
def test_should_return_aggregated_years_if_no_params_given(df_columns) -> None:
    ...
    actual = get_aggregated_data(test_dataframe,
...
def test_should_return_aggregated_authors_if_no_params_given(df_columns) -> None:
    ...
    actual = get_aggregated_data(test_dataframe, column='author')
...
def test_should_return_json_by_author(df_columns) -> None:
    ...
    actual = get_aggregated_data(test_dataframe, column='author', value="author1")
